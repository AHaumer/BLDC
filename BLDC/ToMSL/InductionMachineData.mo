...
record InductionMachineData "Common parameters for induction machines"
  ...
  parameter Modelica.Units.SI.Inertia Jr=0.29 "Rotor's moment of inertia";
  ...
  parameter Modelica.Units.SI.Resistance Rs=0.03
    "Stator resistance per phase at TRef"
    annotation (Dialog(tab="Nominal resistances and inductances"));
  parameter Modelica.Units.SI.Temperature TsRef=293.15
    "Reference temperature of stator resistance"
    annotation (Dialog(tab="Nominal resistances and inductances"));
  parameter Modelica.Electrical.Machines.Thermal.LinearTemperatureCoefficient20 alpha20s=0
  ...
  parameter Modelica.Units.SI.Inductance Lszero=Lssigma
    ...
    annotation (Dialog(tab="Nominal resistances and inductances"));
  parameter Modelica.Units.SI.Inductance Lssigma=3*(1 - sqrt(1 - 0.0667))/(2*pi*
